...
Inputs: proposal_design
Outputs: apply_ready_proposal
Side effect class: repository
...
Produce apply-ready OpenSpec artifacts from accepted exploration and design evidence.