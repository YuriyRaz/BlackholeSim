# orchestrator-v5-authorization

## Purpose

Defines condition-result producer authority, independent result verifier requirements, recovery evidence matching, retry authorization by side-effect class, and recovery record linkage for the v5 orchestrator protocol.
