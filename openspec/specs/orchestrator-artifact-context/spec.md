# orchestrator-artifact-context

## Purpose

Ensure orchestration artifacts crossing the worker boundary carry canonical identity, provenance, and freshness guarantees, and that dependency reports propagate automatically to dependent jobs.
