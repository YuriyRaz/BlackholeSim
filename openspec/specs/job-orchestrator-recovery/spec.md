...
Defines the recovery and state integrity audit behavior for the job orchestrator, ensuring interrupted runs are safely resumed and corrupted state is repaired without duplicate side effects.
