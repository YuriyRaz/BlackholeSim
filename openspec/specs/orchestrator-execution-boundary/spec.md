...
Enforce a strict separation between the root control plane and worker semantic responsibilities, ensuring the root never performs domain work directly, prompts are delivered exactly, and worker responses are handled through validated transport boundaries.
