# Gravitational Wave Sound

## Purpose

Sonifies gravitational wave strain from binary black hole systems using oscillators, chirp frequency sweeps, and dual-polarization synthesis.
